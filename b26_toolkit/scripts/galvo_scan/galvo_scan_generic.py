...
class GalvoScanGeneric(Script):
    ...
    _INSTRUMENTS = {'PB': LISE607RTPulseBlaster}
    _SCRIPTS = {}
    ...
    def _function(self):
        ...
        # print(self.settings['ending_behavior'])
        # print('set galvo now')
    ...
    def _plot(self, axes_list, data = None, colorbar = None):
        ...
        plot_fluorescence_new(data['image_data'], data['extent'], axes_list[0], max_counts=self.settings['max_counts_plot'], min_counts=self.settings['min_counts_plot'], colorbar = colorbar)
